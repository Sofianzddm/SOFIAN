...
const TYPES_CONTENU = [
  ...
  { value: "POST_CROSSPOST", label: "IG Post Crosspost", tarifKey: "tarifPostCrosspost" },
  { value: "REEL", label: "Reel", tarifKey: "tarifReel" },
  { value: "REEL_CROSSPOST", label: "IG Réel Crosspost", tarifKey: "tarifReelCrosspost" },
  { value: "REEL_CONCOURS", label: "IG Réel Jeu Concours", tarifKey: "tarifReelConcours" },
  { value: "TIKTOK_VIDEO", label: "Vidéo TikTok", tarifKey: "tarifTiktokVideo" },
  { value: "TIKTOK_VIDEO_CONCOURS", label: "TikTok Jeu Concours", tarifKey: "tarifTiktokConcours" },
  ...
  { value: "SNAPCHAT_STORY", label: "Snapchat Story", tarifKey: "tarifSnapchatStory" },
  { value: "SNAPCHAT_SPOTLIGHT", label: "Snapchat Spotlight", tarifKey: "tarifSnapchatSpotlight" },

...
export async function GET(request: NextRequest) {
  try {
    // Utiliser la session "effective" (prend en compte l'impersonation admin)
        ...
        data: {
          ...
          tarifs: {
            create: {
              ...
              tarifPostCrosspost: data.tarifPostCrosspost ? parseFloat(data.tarifPostCrosspost) : null,
              tarifReel: data.tarifReel ? parseFloat(data.tarifReel) : null,
              tarifReelCrosspost: data.tarifReelCrosspost ? parseFloat(data.tarifReelCrosspost) : null,
              tarifReelConcours: data.tarifReelConcours ? parseFloat(data.tarifReelConcours) : null,
              tarifTiktokVideo: data.tarifTiktokVideo ? parseFloat(data.tarifTiktokVideo) : null,
              tarifTiktokConcours: data.tarifTiktokConcours ? parseFloat(data.tarifTiktokConcours) : null,
              ...
              tarifSnapchatStory: data.tarifSnapchatStory ? parseFloat(data.tarifSnapchatStory) : null,
              tarifSnapchatSpotlight: data.tarifSnapchatSpotlight ? parseFloat(data.tarifSnapchatSpotlight) : null,

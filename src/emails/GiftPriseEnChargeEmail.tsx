...
export interface GiftPriseEnChargeEmailProps {
  tmName: string;
  amName: string;
  reference: string;
  talentName: string;
...
export function GiftPriseEnChargeEmail({
  tmName,
  amName,
  reference,
  talentName,
  typeGift,
  url,
}: GiftPriseEnChargeEmailProps) {
  const preview = `Ta demande de gift ${reference} a été prise en charge`;
        ...
        <Container style={container}>
          ...
          <Section style={cardSection}>
            ...
            <Text style={paragraph}>
              <strong>{amName}</strong> a pris en charge ta demande de gift&nbsp;:
            </Text>
            ...
            <Section style={infoBox}>
              ...
              <Text style={infoRow}>
                <strong>Account Manager :</strong> {amName}
              </Text>
            </Section>

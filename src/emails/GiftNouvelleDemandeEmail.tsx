...
export interface GiftNouvelleDemandeEmailProps {
  ...
  hotelDatesLabel?: string | null;
  hotelCategorie?: string | null;
  description?: string | null;
  dateSouhaiteeLabel?: string | null;
}

export function GiftNouvelleDemandeEmail({
  recipientName,
  reference,
  talentName,
  typeGift,
  ...
  description,
  dateSouhaiteeLabel,
}: GiftNouvelleDemandeEmailProps) {
  const preview = `Nouvelle demande de gift ${reference} pour ${talentName}`;
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={cardSection}>
            <Text style={greeting}>Bonjour {recipientName || "Glow Up"},</Text>
            <Text style={paragraph}>
              <strong>{tmName}</strong> vient de créer une nouvelle demande de gift&nbsp;:
            </Text>
            ...
            <Section style={infoBox}>
              ...
              <Text style={infoRow}>
                <strong>Type de gift :</strong> {typeGift}
              </Text>
              <Text style={infoRow}>
                <strong>Priorité :</strong> {priorite}
              </Text>
              ...
              {isHotel ? (
                <>
                  {hotelDestination && (
                    <Text style={infoRow}>
                      <strong>Destination :</strong> {hotelDestination}
                    </Text>
                  )}
                  {hotelDatesLabel && (
                    <Text style={infoRow}>
                      <strong>Séjour :</strong> {hotelDatesLabel}
                    </Text>
                  )}
                  {hotelCategorie && (
                    <Text style={infoRow}>
                      <strong>Catégorie :</strong> {hotelCategorie}
                    </Text>
                  )}
                </>
              ) : (
                <>
                  ...
                  {dateSouhaiteeLabel && (
                    <Text style={infoRow}>
                      <strong>Date souhaitée :</strong> {dateSouhaiteeLabel}
                    </Text>
                  )}
                </>
              )}

...
export interface ApprobationEmailProps {
  talentNom: string;
  marqueNom: string;
  reference: string;
  montantBrut: number;
...
export function ApprobationEmail({
  ...
  return (
    <Html lang="fr">
      <Head />
      <Preview>Collaboration {reference} approuvée — Glow Up Agence</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={cardSection}>
            <Text style={title}>Collaboration approuvée</Text>
            <Text style={paragraph}>
              La collaboration <strong>{talentNom} × {marqueNom}</strong> (réf. {reference}) a été soumise par {soumisParNom}.
            </Text>

            <Section style={infoBox}>
              <Text style={infoLine}>📄 Référence : <strong>{reference}</strong></Text>
              <Text style={infoLine}>🎯 {talentNom} × {marqueNom}</Text>
              <Text style={infoLine}>💶 Montant brut : {montantBrut.toLocaleString("fr-FR")} €</Text>
              <Text style={infoLine}>📊 Commission ({commissionPercent}%) : {commissionEuros.toLocaleString("fr-FR")} €</Text>
              <Text style={infoLine}>✅ Net talent : {montantNet.toLocaleString("fr-FR")} €</Text>
            </Section>

            <Text style={paragraph}>
              Consultez le détail de la collaboration via le lien ci-dessous.
            </Text>

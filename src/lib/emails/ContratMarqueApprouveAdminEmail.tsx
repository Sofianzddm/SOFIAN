...
export interface ContratMarqueApprouveAdminEmailProps {
  collaborationLabel: string;
  reviewUrl: string;
}

export function ContratMarqueApprouveAdminEmail({
  collaborationLabel,
  reviewUrl,
}: ContratMarqueApprouveAdminEmailProps) {
  return (
    <Html lang="fr">
      <Head />
        ...
        <Container style={container}>
          ...
          <Section style={cardSection}>
            ...
            <Text style={paragraph}>
              Le contrat marque a été approuvé par le juriste pour : <strong>{collaborationLabel}</strong>.
            </Text>
            <Text style={paragraph}>Vous pouvez lancer la signature côté équipe.</Text>

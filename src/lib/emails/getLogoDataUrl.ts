/**
 * Logo en base64 pour les emails (Gmail bloque les images externes).
 * Lit public/logo.png au moment de l'envoi ; sinon fallback sur le SVG Glow Up en data URI.
 * À utiliser dans les API routes qui envoient des emails (Node uniquement).
 */
import fs from "fs";
...
function getSvgFallbackDataUri(): string {
...
/**
 * Retourne le logo en data URI base64 (PNG si public/logo.png existe, sinon SVG).
 * À appeler côté serveur (API route) avant d'envoyer l'email.
 */
